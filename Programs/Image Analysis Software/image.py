'''
Initial Image processing software

This program:
- Applies basic image processing techniques to a JPEG image taken by capture.py
- Let's the user find the contours(edges) and the area of the plant based meat sample
- Let's the user find the center point of the sample
- Let's the user find the position and the angle of the sample

Purpose:
- Let's the user visually process the images taken by capture.py 
  and find the parameters needed for further batch image analysis
...
# DEFAULT processing settings dictionary
DEFAULTS = {
    # Image
    "image": None,
    # Blur Settings
...
class UI(QMainWindow):
    ...
    def save_settings_as(self):
        ...
        if save_fname:
            ...
            return
    # Save the image that is being displayed in the software with a user given name
    ...
    # Save the image that is being displayed in the software with a default name
    def save_image(self):
        if not hasattr(self, "color_img"):
            QMessageBox.warning(self, "No image", "No processed image available to save.")
            return
    ...
    # Resize the image so that it can be displayed in the software
    ...
    # Load the image to be displayed and processed
    ...
    # Allow the user to choose corners of the sample area using corner_selector.py
    ...
    # Process the image with the user-set techniques below
    def img_processing(self):
        ...
        # Blur the image using the user-set method
        ...
        # Threshold the image using the user-set method
        ...
        # Perfomr morphology to close the egdes of the sample area
        if self.edge_closing_radio_button.isChecked():
            ...
            # Detect the center point and the area of the sample
            if self.area_center_point_detect_checkbox.isChecked():
                ...
                # Mark the countours and the center point of the sample area 
                # and calculate it's tilt
