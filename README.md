...
## Aim
In recent years, there has been increasing interest in the development of alternative proteins, such as plant-based meats. However, most market share in the plant-based meat industry to date has been concentrated in developed regions such as North America and Europe, where consumer demand and retail infrastructure are currently strongest. This lack of access not only prevents such countries and institutions from engaging in the field but may also hinder the global advancement of alternative protein research.
...
## Theory
The proposed approach exploits the characteristic infrared light absorption of water, using illumination from a simple halogen light source and image acquisition with a Raspberry Pi camera. By relying on simple optical components and image-based analysis rather than specialized instrumentation, the device provides a practical alternative for initial characterization of plant-based meat products. Another advantage of the proposed device, compared to simpler methods of moisture evaluation such as estimating moisture content from the ingredients used or tracking mass changes with a conventional scale, is its potential to spatially estimate the water distribution within the sample, which is not uniform under real conditions. Furthermore, the public availability of both the hardware schematics and software allows students and other individuals to reproduce, modify, and further develop the proposed device, thereby enhancing its educational and research value.
